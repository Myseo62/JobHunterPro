...
export function SimpleResumeUploader({ userId, onUploadComplete }: SimpleResumeUploaderProps) {
        ...
        <div className="space-y-4">
          ...
          {isUploading ? (
            ...
            <div className="p-8 border-2 border-dashed border-gray-300 rounded-lg text-center hover:border-purple-400 transition-colors">
              ...
              <div className="mt-3">
                <label htmlFor="resume-file-input-direct" className="cursor-pointer">
                  <Button 
                    variant="outline"
